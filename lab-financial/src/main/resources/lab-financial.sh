...
#启动项目的名称
APP_NAME=lab-financial

#启动JAR包
APP_JAR=lab-financial.jar
#需要启动的Java主程序（main方法类）
APP_MAINCLASS=ac.cn.saya.lab.financial.FinancialApplication

#程序目录，如开机自启失败，手动设置
#APP_HOME=$(pwd)
APP_HOME="/Users/saya/project/java/lab/lab-financial/target/lab-financial"
#程序进程号
APP_PID=$APP_HOME/lab-financial.pid
...
stop() {
   ...
   if [ $pids -ne 0 ]; then
      ...
      rm -rf $APP_HOME/lab-financial.pid
