...
#启动JAR包
APP_JAR=lab-http.jar
#需要启动的Java主程序（main方法类）
APP_MAINCLASS=ac.cn.saya.lab.http.LabHttpApplication

#程序目录，如开机自启失败，手动设置
#APP_HOME=$(pwd)
APP_HOME="/Users/saya/project/java/lab/lab-http/target/lab-http"
#程序进程号
APP_PID=$APP_HOME/lab-http.pid
