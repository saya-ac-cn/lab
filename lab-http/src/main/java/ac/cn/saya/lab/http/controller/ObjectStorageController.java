...
public class ObjectStorageController {
    ...
    @Autowired
    private IObjectStorageService objectStorageServiceImpl;
    ...
    public Result<Object> updateNewsPicture(@RequestBody PictureEntity entity, HttpServletRequest request){
    ...
    public Result<Object> updateWallpaperPicture(@RequestBody MultipartFile file, HttpServletRequest request){
    ...
    public Result<Object> uploadFile(@RequestBody MultipartFile file, @RequestParam(value = "uid", required = false) String uid, HttpServletRequest request){
    ...
    public Result<Object> editFile(@RequestBody FilesEntity entity, HttpServletRequest request){
    ...
    public Result<Object> downloadFileForAdmin(@PathVariable("id") int id, HttpServletRequest request, HttpServletResponse response){
    ...
    public Result<Object> downloadBackUpDB(@RequestParam("archiveDate") String archiveDate, HttpServletResponse response){
