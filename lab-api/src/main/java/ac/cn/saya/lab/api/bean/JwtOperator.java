...
public class JwtOperator {
    ...
    private static Logger logger = LoggerFactory.getLogger(JwtOperator.class);
    ...
    public static void main1(String[] args) {
        ...
        // 100年
        jwtOperator.expirationTimeInSecond = 3153600000L;
        jwtOperator.secret = "vZ0N6kgV8UoMfM4YFZeXvzpmzWhADq1PUXcXdCa1Pi9AugCQdO0wKEubIpbp5xt7";

        // 2.设置用户信息
        HashMap<String, Object> objectObjectHashMap = Maps.newHashMap();
        objectObjectHashMap.put("account","private_lab");
        objectObjectHashMap.put("name","private_lab");
        objectObjectHashMap.put("ip","127.0.0.1");
        objectObjectHashMap.put("city","四川省自贡市");
